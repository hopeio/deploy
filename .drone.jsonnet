...
local Pipeline(repo, group, name='', mode='app', type='bin' , buildDir='', sourceFile='', protopath='', opts=[], compile='localhost',target = 'tx', schedule='') = {
  ...
  steps: [
    {
	  ...
	  'git clone ${DRONE_GIT_HTTP_URL} /deploy',
...
[
  Pipeline('https://github.com/hopeio/toolbox','hoper', buildDir='server/go', protopath='server/go/protobuf'),
]
